<template>
  <div class="mainWrapper">
    <Header title="审批管理" text="我的审批"></Header>
    <div class="table">
                ...
                <el-popover trigger="click" placement="bottom" width="150">
                  <ul>
                    <li style="text-align: center;margin-bottom: 10px">
                      <el-button type="success" size="small" style="width: 80px" @click="checkW(scope.row.ID)">撤回</el-button>
                    </li>
                    <li style="text-align: center;margin-bottom: 10px">
                      <el-button type="primary" size="small"  style="width: 80px" @click="dg1=true">审批日志</el-button>
                    </li>
                  </ul>
    ...
    <el-dialog title="审批日志" :visible.sync="dg1">
      <div slot="footer">
