    ...
    <div class="main">
        <el-row>
            <el-col :span="6">
                ...
                <el-table :data="tableData" ref="multipleTable" :header-cell-style="{'text-align':'center'}" :cell-style="{'text-align':'center'}" @row-click='SelectClick()'>
            ...
            <el-col :span="17">
                ...
                <el-table :data="data" border :header-cell-style="{'text-align':'center'}" :cell-style="{'text-align':'center'}">
