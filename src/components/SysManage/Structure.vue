      ...
      <el-row>
        <el-col :span="5">
          ...
          <div>
            ...
            <el-dialog title="新建人员" :visible.sync="digl">
                  <el-form :inline="true">
          ...
          >
            ...
            <el-table-column label="操作">
              <el-button type="text" @click="dg1=true">修改</el-button>
                <el-dialog title="修改人员" :visible.sync="dg1">
                  <el-form :inline="true">
                    <el-form-item label="姓名:">
...
export default {
  ...
  data() {
    return {
      ...
      rowinfo:{name:'asadas',gnum:'64565556566',leader:false,level:true,sex:'男',stru:'1-1-2',tel:'4564564464',date:'2019-7-11',cd:'TesA',device:1},
      rowinf:{name:'asadas',gnum:'64565556566',leader:false,level:true,user:false,sex:'男',stru:'1-1-2',tel:'4564564464',date:'2019-7-11',cd:'TesA',device:1},
      dg1:false,
      dialog1: false,
      treedata: [
        {
...
.el-table .el-form,.dlg .el-form{
  text-align: left
}

.el-table .el-form .el-form-item,.dlg .el-form .el-form-item{
  margin-left:0
}
